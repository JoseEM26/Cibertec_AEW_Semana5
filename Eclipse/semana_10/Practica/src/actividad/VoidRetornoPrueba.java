...
public class VoidRetornoPrueba extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VoidRetornoPrueba frame = new VoidRetornoPrueba();
	...
	public VoidRetornoPrueba() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			int getCantidad(int cantidad) {
				return cantidad=Integer.parseInt(txtCantidad.getText());
			}
			double getTipo(double tipo) {
				return tipo=cbotipo.getSelectedIndex();
			}
			
			double CalcularImpCompra(int tipo,int cantidad) {
				...
				case 0:
					...
					break;
				case 1:
					importeCompra=cantidad*10;
					break;
				case 2:
					importeCompra=cantidad*7;
					break;
				case 3:
